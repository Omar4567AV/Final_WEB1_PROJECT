      ...
      <div className="sm:mx-auto w-full sm:max-w-md bg-white p-8 rounded-xl shadow-sm border border-slate-200">
        <div className="text-center mb-6">
          ...
          <p className="mt-2 text-sm text-slate-500">
            We sent a 6-digit verification code to your email. It expires in 5 minutes.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input
              ...
              placeholder="000000"
              className="block w-full tracking-[0.5em] text-center font-mono text-lg text-slate-900 rounded-md border border-slate-200 bg-white px-3 py-2 focus:border-blue-500 focus:outline-none"
            />
          </div>
